...
('导入第三方订单', '/bill/third_part_bill/import', unix_timestamp(now()), 'post', 1, '导入第三方订单', 57, 'third_part_bill_import'),
('第三方订单列表', '/bill/third_part_bill/list', unix_timestamp(now()), 'get', 0, '', 57, 'third_part_bill_list'),
('下载导入订单模板', '/bill/third_part_bill/download_template', unix_timestamp(now()), 'get', 0, '', 57, 'third_part_bill_download_template');