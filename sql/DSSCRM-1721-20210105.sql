...
VALUES
  ...
  -- prod:('message_rule_config', '消息推送规则', 'assign_template_id', '5Qmy_EEfWfQCBOffhD5P252ev__VmQlxJaB9MqkLABE', '手动push消息默认模板id'),
