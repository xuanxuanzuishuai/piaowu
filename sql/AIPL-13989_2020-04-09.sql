...
CREATE TABLE `erp_user_event_task_award_gold_leaf` (
    ...
    `uuid` varchar(32) NOT NULL DEFAULT '' COMMENT '奖励用户的唯一id',
    `user_type` tinyint(4) NOT NULL COMMENT '被奖励人类型 用户类型 1 学员 2 老师 3 机构',
    `event_task_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '活动任务id 对应event_task表',
    `award_num` int(10) NOT NULL DEFAULT '0' COMMENT '奖励的额度',
