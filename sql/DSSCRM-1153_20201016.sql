...
VALUES ('课管学员分配', '/org_web/leads_pool/cm_pool_list', unix_timestamp(), 'get', 1, '课管学员分配', @pid, 'cm_pool_list', 1);

INSERT INTO `privilege` (`name`, `uri`, `created_time`, `method`, `is_menu`, `menu_name`, `parent_id`, `unique_en_name`, `status`)
VALUES ('新增课管线索池', '/org_web/leads_pool/add_cm_pool', unix_timestamp(), 'post', 0, '', @pid, 'add_cm_pool', 1);

INSERT INTO `privilege` (`name`, `uri`, `created_time`, `method`, `is_menu`, `menu_name`, `parent_id`, `unique_en_name`, `status`)
VALUES ('编辑课管线索池', '/org_web/leads_pool/update_cm_pool', unix_timestamp(), 'post', 0, '', @pid, 'update_cm_pool', 1);

INSERT INTO `privilege` (`name`, `uri`, `created_time`, `method`, `is_menu`, `menu_name`, `parent_id`, `unique_en_name`, `status`)
VALUES ('课管线索池详情', '/org_web/leads_pool/cm_pool_detail', unix_timestamp(), 'get', 0, '', @pid, 'cm_pool_detail', 1);

INSERT INTO `privilege` (`name`, `uri`, `created_time`, `method`, `is_menu`, `menu_name`, `parent_id`, `unique_en_name`, `status`)
VALUES ('获取部门内的课管成员', '/org_web/employee/get_dept_course_manage', unix_timestamp(), 'get', 0, '', 0, 'get_dept_course_manage',1);
