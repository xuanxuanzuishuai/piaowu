...
-- EVENT:
('CHECKIN_PUSH_CONFIG', '打卡签到设置', 'collection_event_id', '', '参加打卡活动班级关联的EVENT ID'),
...
VALUES
 ...
 CREATE TABLE `message_record_log` (
  ...
  `activity_type` tinyint(1) DEFAULT NULL COMMENT '推送的类别 3基于规则的手动push;4基于规则的自动push;5体验营打卡',
  `relate_id` int(11) DEFAULT NULL COMMENT '不同类别关联不同表的id',
  `push_res` tinyint(1) DEFAULT NULL COMMENT '推送结果0失败1成功',
  `receive_res` tinyint(1) DEFAULT NULL COMMENT '接收结果0失败1成功',
