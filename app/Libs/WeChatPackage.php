...
class WeChatPackage
{
    ...
    {
        return isset($this->values['mch_id']) ? $this->values['mch_id'] : $_ENV['STUDENT_WEIXIN_MCH_ID'];
    }

    public function get_wxappid()
    {
        return isset($this->values['wxappid']) ? $this->values['wxappid'] : $_ENV['STUDENT_WEIXIN_APP_ID'];
    }
    ...
    {
        return isset($this->values['mch_appid']) ? $this->values['mch_appid'] : $_ENV['STUDENT_WEIXIN_APP_ID'];

    }

    public function get_mchid()
    {
        return isset($this->values['mchid']) ? $this->values['mchid'] : $_ENV['STUDENT_WEIXIN_MCH_ID'];
...
eof;
    ...
    public function curl_post_ssl($url, $vars, $second = 30, $aHeader = array())
    {
        ...
        curl_setopt($ch, CURLOPT_SSLCERT, $_ENV['WECAHT_APICLIENT_CERT_PATH']);
        curl_setopt($ch, CURLOPT_SSLKEY, $_ENV['WECHAT_APICLIENT_KEY_PATH']);
