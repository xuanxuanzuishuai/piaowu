...
use App\Libs\Util;
use App\Libs\Valid;
use App\Services\InviteActivityService;
use Slim\Http\Request;
use Slim\Http\Response;
use Slim\Http\StatusCode;

class InviteActivity extends ControllerBase
{
    /**
     * 活动添加
    ...
    public function save(Request $request, Response $response)
    {
        ...
        try {
            ...
            if (!empty($params['activity_id'])) {
                InviteActivityService::edit($params, $employeeId);
            } else {
                InviteActivityService::add($params, $employeeId);
            }
    ...
    public function list(Request $request, Response $response)
    {
        ...
        try {
            ...
            $data = InviteActivityService::searchList($params, $page, $limit);
        } catch (RunTimeException $e) {
            return HttpHelper::buildOrgWebErrorResponse($response, $e->getWebErrorData(), $e->getData());
        }
    ...
    public function detail(Request $request, Response $response)
    {
        ...
        try {
            $data = InviteActivityService::getDetailById($params['activity_id']);
        } catch (RunTimeException $e) {
            return HttpHelper::buildOrgWebErrorResponse($response, $e->getWebErrorData(), $e->getData());
        }
        return HttpHelper::buildResponse($response, $data);
    ...
    public function editEnableStatus(Request $request, Response $response)
    {
        ...
        try {
            $employeeId = $this->getEmployeeId();
            InviteActivityService::editEnableStatus($params['activity_id'], $params['enable_status'], $employeeId);
        } catch (RunTimeException $e) {
            return HttpHelper::buildOrgWebErrorResponse($response, $e->getWebErrorData(), $e->getData());
        }
        return HttpHelper::buildResponse($response, []);
