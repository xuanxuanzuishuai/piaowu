...
class PosterTemplate extends ControllerBase
{
    ...
    public function individualityAdd(Request $request, Response $response)
    {
        ...
        $rules = [
            ...
            [
                'key' => 'poster_status',
                'type' => 'required',
                'error_code' => 'poster_status_is_required'
            ],
            [
                'key' => 'order_num',
                'type' => 'required',
        ...
        try{
            //参数校验
            $params['poster_name'] = Util::filterEmoji($params['poster_name']);
    ...
    public function getPosterInfo(Request $request, Response $response)
    {
        ...
        $info = PosterTemplateService::getOnePosterInfo($params['poster_id']);
        return HttpHelper::buildResponse($response, [
            'data' => $info
        ]);
    }
