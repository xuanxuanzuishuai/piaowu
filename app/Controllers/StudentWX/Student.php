    ...
    public function register(Request $request, Response $response)
    {
        ...
        try {
            (new DeviceCommonTrackTopic)->pushLogin([
                ...
                'unionid'      => WeChatMiniPro::factory(Constants::SMART_APP_ID, Constants::SMART_WX_SERVICE)->getUnionid($data['openid'] ?? ''),
            ])->publish();
        } catch (\Exception $e) {
    ...
    public function login(Request $request, Response $response)
    {
        ...
        try {
            (new DeviceCommonTrackTopic)->pushLogin([
                ...
                'anonymous_id' => $request->getHeader('anonymous_id')[0] ?? '',   // 埋点匿名id, 投放页有
                'unionid'      => WeChatMiniPro::factory(Constants::SMART_APP_ID, Constants::SMART_WX_SERVICE)->getUnionid($openId),
            ])->publish();
        } catch (\Exception $e) {
