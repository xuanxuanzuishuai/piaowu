...
class OrgWebRouter extends RouterBase
{
    ...
    protected $uriConfig = [
        ...
        '/org_web/referee/update_award' => ['method' => ['post'], 'call' => Referral::class . ':refereeUpdateAward'],
        '/org_web/referee/award_list'   => ['method' => ['get'],  'call' => Referral::class . ':refereeAwardList'],
