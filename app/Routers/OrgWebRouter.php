...
use App\Controllers\OrgWeb\MorningTaskAwardActivityManage;
...
class OrgWebRouter extends RouterBase
{
    ...
    protected $uriConfig = [
        ...
        //商家代理
        '/op_web/agent_business/add' => ['method' => ['post'], 'call' => AgentOrg::class . ':add'],
        '/op_web/agent_business/update' => ['method' => ['post'], 'call' => AgentOrg::class . ':update'],
        '/op_web/agent_business/detail' => ['method' => ['get'], 'call' => AgentOrg::class . ':detail'],
        ...
        '/op_web/package/import_ready' => ['method' => ['get'], 'call' => Package::class . ':importReady'],
        ...
        ********************************************************************************************************************************************************/
        ...
        '/op_web/real_week_activity/designate_uuid_check' => ['method' => ['post'], 'call' => RealWeekActivity::class . ':designateUUIDCheck'],
        //真人转介绍管理 - 月月有奖
