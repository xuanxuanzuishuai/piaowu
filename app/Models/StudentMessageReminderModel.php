...
class StudentMessageReminderModel extends Model
{
    ...
    const MESSAGE_TYPE_GOLD_LEAF_REFEREE_TRIAL_AWARD_WAITING_RECORDED_REMINDER = 2;//智能转介绍付费体验卡获取到的金叶子待入账提醒
    const MESSAGE_TYPE_GOLD_LEAF_REFEREE_BUY_TRIAL_AWARD_WAITING_RECORDED_REMINDER = 3;//智能转介绍付费体验卡获取到的金叶子待入账提醒
    const MESSAGE_TYPE_GOLD_LEAF_REFEREE_NORMAL_AWARD_WAITING_RECORDED_REMINDER = 4;//智能转介绍付费付费年卡获取到的金叶子待入账提醒
    const MESSAGE_TYPE_GOLD_LEAF_WEEK_ACTIVITY_WAITING_RECORDED_REMINDER = 5;//智能周周领奖活动获取到的金叶子待入账提醒
    const MESSAGE_TYPE_GOLD_LEAF_CUMULATIVE_INVITE_BUY_YEAR_CARD_WAITING_RECORDED_REMINDER = 6;//智能付费年卡累计奖励获取到的金叶子待入账提醒
    const MESSAGE_TYPE_GOLD_LEAF_REFERRAL_RT_COUPON_WAITING_RECORDED_REMINDER = 7;//智能亲友专属福利获取到的金叶子待入账提醒
