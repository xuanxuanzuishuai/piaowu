...
abstract class LimitTimeActivityBaseAbstract implements LimitTimeActivityBaseInterface
{
	...
	public static function formatTargetUser($targetUser)
	{
        ...
        $targetUser['play_intensity_start_time'] = !empty($targetUser['play_intensity_start_time']) ? date("Y-m-d H:i:s", $targetUser['play_intensity_start_time']) : '';
        $targetUser['play_intensity_end_time'] = !empty($targetUser['play_intensity_end_time']) ? date("Y-m-d H:i:s", $targetUser['play_intensity_end_time']) : '';
		return $targetUser;
	}
