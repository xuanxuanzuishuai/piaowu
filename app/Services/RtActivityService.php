...
class RtActivityService
{
    ...
    private static function formatListData($data)
    {
        ...
        if ($data['coupon_status'] == ErpStudentCouponV1Model::STATUS_USED
            &&
            $data['order_status']==ErpOrderCouponV1Model::STATUS_ENABLE
        ) {
    ...
    public static function handleFreeOrder($request, $isRegister = false, $student = [])
    {
        ...
        if ($isRegister) {
            ...
            StudentService::studentLoginActivePushQueue(Constants::SMART_APP_ID, $student['id'], Constants::DSS_STUDENT_LOGIN_TYPE_H5, $request['channel_id'] ?? 0);
